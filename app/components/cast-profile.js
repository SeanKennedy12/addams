...
export default function CastProfile({ img, img2, character, actor, alt }) {
    ...
    return (
        <div className='grid md:grid-cols-2 justify-items-center items-center'>
            ...
            <img width={200} height={200} className='rounded-full md:ml-auto md:mr-8' onMouseOver={handleMouseOver} onMouseOut={handleMouseOut} onClick={handleClick} src={image} alt={alt} />
            <img width={200} height={200} className='rounded-full md:ml-auto md:mr-8 hidden' src={img2} />
