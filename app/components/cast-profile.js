...
export default function CastProfile({ img, img2, character, actor, alt, id1, id2 }) {
    ...
    return (
        <div className='grid md:grid-cols-2 justify-items-center items-center'>
            ...
            <Image width={200} height={200} className='rounded-full md:ml-auto md:mr-8' id={id1} src={img} priority={true} onClick={handleClick1} onMouseOver={handleOver} alt={alt} />
            <Image width={200} height={200} className='rounded-full md:ml-auto md:mr-8 hidden' id={id2} src={img2} priority={true} onClick={handleClick2} onMouseOut={handleOut} alt={alt} />
