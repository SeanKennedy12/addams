        ...
        <>
            <main className='px-8 py-6'>
                ...
                <div className='flex flex-col items-center lg:flex-row lg:items-start text-justify'>
                    <Image width={0} height={0} sizes='100vw' className='w-[100%] lg:w-[25vw] h-[auto]' src='/static/images/about-main.jpeg' alt='Main cast' />
                ...
                <div className='flex flex-col lg:flex-row-reverse mt-4 lg:mt-8 text-justify'>
                    <Image width={0} height={0} sizes='100vw' className='w-[100%] lg:w-[15vw] h-[auto]' src='/static/images/popcorn.jpg' alt='Popcorn' />
                ...
                <div className='flex flex-col lg:flex-row mt-8 text-justify'>
                    <Image width={0} height={0} sizes='100vw' className='w-[100%] lg:w-[15vw] h-[auto]' src='/static/images/tombola.jpg' alt='Tombola' />
                    <div className='pt-4 lg:pl-4 lg:pt-0'>
